pipeline {
    ...
    parameters {
        string(name: 'GIT_REPO', description: 'Git Repository URL', defaultValue: 'https://github.com/kachhap1/College_Website-static-.git')
    ...
    stages {
        ...
        stage('Deploy to Apache') {
            steps {
                script {
                    def sourceDir = "C:\\Users\\vicky\\OneDrive\\Desktop\\college_Website"
